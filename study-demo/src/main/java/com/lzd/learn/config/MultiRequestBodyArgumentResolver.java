...
import com.lzd.learn.annotation.MultiRequestBody;
 ...
 * 遗留问题：
 *    1.对封装成Map集合参数无效
 *    2.使用该注解的同时 存在 不可以使用其他注解问题（例如：与@RequestBody同时使用会报错）
 * @author lzd
 * @date 2019年4月8日
 * @version
 */
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public boolean supportsParameter(MethodParameter parameter) {
		...
		//return parameter.getParameterAnnotation(MultiRequestBody.class) !=null;
