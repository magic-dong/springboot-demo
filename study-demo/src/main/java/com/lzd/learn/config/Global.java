...
import com.lzd.learn.utils.YamlUtils;
...
public class Global
{
    ...
    {
        return StringUtils.nvl(getConfig("quotation.name"), "Quotation-Web");
    }
    ...
    {
        return StringUtils.nvl(getConfig("quotation.version"), "1.0.0");
    }
    ...
    {
        return StringUtils.nvl(getConfig("quotation.copyrightYear"), "2019");
    }
    ...
    {
        return getConfig("quotation.profile");
    }
